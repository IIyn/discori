<h1 align="center">Discori</h1>

<p align="center">
    Discori is a Discord wrapper made with Tauri. It is a fork from <a href="https://github.com/DiscordTauri/discord-tauri">Discord Tauri</a>. as it became archive in 2023 and I wanted to migrate it to Tauri v2 and continue its development.

    You will find below the old README.md from the original project.
</p>
...
This project's purpose is to, not only know how Discord would be if it was built in Tauri; but also learn about Discord's inner workings and possibly get more people to know about [Tauri](https://v2.tauri.app)!
...
# Building
Let's keep it simple, if you want to build it just run `bun run tauri dev`.
...
It's a Discord wrapper that uses the lightweight library [Tauri](https://v2.tauri.app). In the current state of development, we are replicating the original Discord client behavior.
